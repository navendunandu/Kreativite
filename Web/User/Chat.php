...
<?php
   ...
   $selQry =  "select * from tbl_hiringteam where hiring_id='".$_GET["chatId"]."'";
    ...
    <div class="nav-start">
        <div class="recipient-block">
            <div class="avatar-container">
                <img class="user-avatar" src="../Assets/Files/Hiringteam/Photo/<?php echo $row["hiring_photo"] ?>" alt="">
            </div>
            <div class="username">
    ...
    <div class="chat-action">
        <div class="chat-action-inner">
            <div class="control" style="text-align: center">
                ...
                <input type="hidden" value="<?php echo $_GET["chatId"]; ?>" name="txt_hid"  id="txt_id" onclick="sendChat()">
