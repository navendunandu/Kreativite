...
if (isset($_POST["btn_submit"])) {
    $insQry = "insert into tbl_complaint(complaint_title,complaint_content,hiring_id,user_id,complaint_from) values('" . $_POST["complaint-title"] . "','" . $_POST["complaint-content"] . "','" . $_SESSION["hid"] . "','".$_GET["complaintId"]."','Hiring-team')";
    if($con->query($insQry))
    {
        echo "Success";
    }
        ...
        <form method="post" class="needs-validation" novalidate>
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <textarea oninput="textval()" required class="form-control" name="complaint-content" id="complaint-content" cols="30" rows="10" maxlength="100"></textarea>
                        <span id="target"></span>
                        <div class="invalid-feedback">Please fill this field</div>
                    </td>
                </tr>
