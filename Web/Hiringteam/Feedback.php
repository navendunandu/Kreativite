...
{
    $insQry = "insert into tbl_feedback(feedback_content,hiring_id) values('".$_POST["feedback-content"]."','".$_SESSION["hid"]."')";
if($con->query($insQry))
{
    echo "Success";
}
...
<div class="container mt-5">
        ...
        <form method="POST" class="needs-validation" novalidate>
            <div class="form-group">
                ...
                <textarea required class="form-control" name="feedback-content" id="feedback" rows="5" oninput="textval()" maxlength="100"></textarea>
                <span id="target"></span>
