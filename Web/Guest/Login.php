          ...
          <div class="row">
                ...
                <div class="card-body">
                  <form role="form" method="post">
                    ...
                    <div class="text-center">
                      <input type="submit" name="btn_submit" class="btn bg-gradient-info w-100 mt-4 mb-0" value='Sign in' />
                    </div>
                  </form>
                </div>
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../Assets/Templates/Admin/img/curved-images/curved6.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
