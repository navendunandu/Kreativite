  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
        target="_blank">
        <img src="../Assets/Templates/Admin/img/logo-ct-dark.png" class="navbar-brand-img h-100" alt="main_logo">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="./AdminRegistration.php">
            ...
            <span class="nav-link-text ms-1">Admin Registration</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="./HiringTeamVerification.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Hiring Team Requests</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="./HiringTeamAcceptedList.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Verified Hiring Team</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="./HiringTeamRejectedList.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Rejected Hiring Team</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="./LocationLenderVerification.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <!-- <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="nav-link-text ms-1">Location Lender Requests</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="./LocationLenderAcceptedList.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <!-- <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="nav-link-text ms-1">Verified Location Lender</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="./LocationLenderRejectedList.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <!-- <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="nav-link-text ms-1">Rejected Location Lender</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="./UserType.php">
            ...
            <span class="nav-link-text ms-1">User Types</span>
          </a>
        </li>
      </ul>
    </div>
              ...
              <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="../Assets/Templates/Admin/img/team-2.jpg" class="avatar avatar-sm  me-3 ">
                      </div>
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="../Assets/Templates/Admin/img/small-logos/logo-spotify.svg"
