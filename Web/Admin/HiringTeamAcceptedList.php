...
{
	$updateQry = "update tbl_hiringteam set hiring_vstatus = 2 where hiring_id='".$_GET["reject"]."'";
...
<title>HiringTeamAcceptedList</title>
</head>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="HiringTeamAcceptedList.php?reject=<?php echo $row["hiring_id"] ?>" class="btn btn-danger">Reject</a>
                            </td>
                        </tr>
                    <?php
                    }
